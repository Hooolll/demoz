...
public class ProductService {
    ...
    public void save(Product product) {
        ...
        if(null == product.getCategory()) {
            throw new PosException("Пожалуйста выберите категорию");
        }

        if(StringUtils.isEmpty(product.getName())) {
            throw new PosException("Пожалуйста введите имя товара");
        }

        if(product.getPrice() == 0) {
            throw new PosException("Пожалуйста введите цену товара");
        }
