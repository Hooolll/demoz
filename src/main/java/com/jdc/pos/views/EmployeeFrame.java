...
public class EmployeeFrame {
    ...
    private void initialize() {
        loadView(Menu.HomeEmployee);
    }

    @FXML
    private void clickMenu(MouseEvent event2) {
    ...
    public static void show() {
        ...
        try {
            ...
            Parent root = FXMLLoader.load(Objects.requireNonNull(EmployeeFrame.class.getResource("EmployeeFrame.fxml")));
